...
export default {
  ...tailwind,
  breakpoints: ["580px", "768px", "1024px", "1440px"],
  fonts: {
    ...tailwind.fonts,
  ...
  sizes: {
    ...
    logoWidthLarge: "70px", // Logo width on large screens, above 1024px
    ...
    logoHeightLarge: "70px", // Logo width on large screens, above 1024px
