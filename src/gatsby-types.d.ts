...
type Unnamed_1_Query = { readonly allMarkdownRemark: { readonly nodes: ReadonlyArray<{ readonly id: string, readonly frontmatter: { readonly authorId: string | null } | null, readonly fields: { readonly slug: string | null } | null }> } };
