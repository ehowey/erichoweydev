...
excerpt: Automating the creation of custom open graph images opens up interesting business use cases from personalized conference tickets to shareable user profiles and more. Fundamentally automated OG images unlock personalized information sharing at scale.
...
If you have been following along you should be able to deploy your project and view your new edge function via the raw URL which will be `https://www.mysite.com/api/og-image`.
