...
What we so far works, but it really isn't that special or eye catching. We need some pop!

Using the generated images we are limited to what we can create using CSS and SVGs and the [Satori rendering engine](https://github.com/vercel/satori). The key here is the ability to use inlined SVGs as this lets you add in quite a bit of pop while keeping within the limitations of what is possible with Satori.
