...
My son in grade 3 recently had to make a bar chart of his classmates favourite kinds of weather. So let's start there!

Data for Tremor charts has index values which are the value used as labels on the axis. It also has what are called categories which are the values actually charted on the graph.
