...
import ChartLoader from '~/components/nextjs-tremor-post/ChartLoader.tsx'
...
Under the hood Tremor is using a library called [Recharts](https://recharts.org/en-US) for the charts.
...
```tsx title="DonutChart.tsx" {24-28, 32, 52}
import { DonutChart, Card } from '@tremor/react'
