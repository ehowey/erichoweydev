...
Tremor includes a great default tooltip and while you have full control to make your own tooltip odds are you will want to simply extend the default tooltip so that your styles remain consistent across the charts.

<BlockquoteInfo>
  This default tooltip is based on the tooltip in use from late 2023, it is
  possible this has changed over time. You can figure out the default tooltip
  yourself by using the code inspector in your browser and copy/pasting the
  Tailwind styling you see there.
</BlockquoteInfo>
