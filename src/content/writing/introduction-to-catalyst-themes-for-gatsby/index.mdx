...
date: 2020-01-01
published: true
description: A beginner's guide to Gatsby themes using the popular Catalyst starter theme as an example.
excerpt: Gatsby Theme Catalyst is my opinionated view of a modern tech stack relying on a combination of Gatsby, MDX, and Theme UI. I built this series of themes to accelerate the development process and have a modular approach for my freelance work. As a side benefit building this project has been a great way to learn exciting new technologies including React and GraphQL.
---
...
![Model of catalyst themes and starters](/images/catalyst-model.png 'Model of catalyst themes and starters')
...
![Catalyst Blog Screenshot 1](/images/cat-blog-screenshot-1.png 'Catalyst Blog Screenshot 1')
