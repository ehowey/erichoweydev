...
Most websites are not so minimal and include images, icons, background patterns, etc. If you are lucky, these will all look fine in dark mode but odds are they won’t. For example the images that look good with a light background might visually clash against a darker background.
...
**A full example hero section switching images**
