...
socialImage: ../post-assets/featured-writer-theme.jpg
---

> This theme has been depreciated, instead use [gatsby-theme-catalyst-hydrogen](https://www.gatsbycatalyst.com/docs/tutorials/building-a-website-for-a-freelance-writer-using-gatsby-theme-catalyst-hydrogen), which is an updated version of this theme with an improved API.
