...
categories: [Gatsby]
date: 2020-12-21
featuredImage: ../post-assets/featured-load-more.jpg
socialImage: ../post-assets/social-load-more.jpg
---
...
Finally the `hasMore` boolean is used as a ternary operator in the JSX to conditionally show either the load more button or an alert to the user that there are no more articles.
