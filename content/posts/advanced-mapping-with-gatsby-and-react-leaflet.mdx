...
Just a quick word about map tiles. In the demo code you will notice that I am using OpenStreetMap tiles. This is fine for testing or playing around but in production you will need to use, and pay, for map tiles. I reviewed a few different options and ended up going with [MapBox](https://www.mapbox.com/) but there are lots of different options to choose from.
